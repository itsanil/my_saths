...
@section('section_page', 'Add Combo')
@section('css')
  <!-- Select2 -->
...
<div class="row">
    <div class="card card-info" style="min-width: 100%;">
            <form class="pl-3 pr-3" action="{{ route('products-combo.store') }}" id="form_add" method="POST" enctype="multipart/form-data">
                                @csrf
                    <div class="form-group">
                        <label for="username">Enter Combo Name</label>
                        <input type="text"  class="form-control" name="product_combo_name" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group sel-product">
                        ...
                        <section id="Most-Sell-Product">
                                ...
                                <div class="form-check">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="checkbox" name="product_id[]" class="form-check-input" data="{{ $value->sale_price }}" value="{{ $value->id }}_1">
                                            <label class="form-check-label">{{ $value->name }}</label>
                                        </div>
                                        <!-- <div class="col-md-3">
                                            <label class="form-check-label">Actual Sale Price : {{ $value->sale_price }}</label>
                                        </div> -->
                                        <div class="col-md-6">
                                            <label class="form-check-label">
                                                <input type="number" class="form-control product_qty" min="1" name="product_qty[]" data="{{ $value->id }}" value="1" >
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control product_qty" name="price" placeholder="enter sale price" required="">
                        </div>
                    </div>
                    <section id="html">
