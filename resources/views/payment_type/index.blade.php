...
@section('section_page', 'Payment Options')
@section('css')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                                <b>Add Payment Options</b>
                </div>
                <form class="pl-3 pr-3" action="{{ route('payment-options.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                    <div class="form-group">
                        <label for="username">Name</label>
                        <input class="form-control" type="name" id="name" name="name" required="" placeholder="Enter Payment Type">
                    </div>
...
<div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                    <b>Edit Payment Type</b>
                </div>
                <form class="pl-3 pr-3" id="editform" action="{{ url('/update-payment-options') }}" method="POST" enctype="multipart/form-data">
                                @csrf
