...
@section('section_page', 'Privacy Policy')
@section('css')
...
<p>Welcome to <b> Savita's Grocery</b>.</p>
<p><b>Savita's Grocery</b> ('us', 'we', or 'our') operates <b>sgonline.in</b> (hereinafter referred to as <b>'Service'</b>).</p>
<p>Our Privacy Policy governs your visit to <b>sgonline.in</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
...
<p><b>SERVICE</b> means the sgonline.in website operated by Savita's Grocery.</p>
...
<p>This Usage Data may include information such as your computerâ€™s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>
...
<p>Savita's Grocery uses the collected data for various purposes:</p>
...
<p>Your information, including Personal Data, may be transferred to â€“ and maintained on â€“ computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.</p>
...
<p>Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third partyâ€™s site. We strongly advise you to review the Privacy Policy of every site you visit.</p>
<p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

<p>16. <b><b>Childrenâ€™s Privacy</b></b></p>
...
<p>If you have any questions about this Privacy Policy, please contact us by email: <b>support@sgonline.in</b>.</p>
                    </div>
                 </div>
</div>
 <div class="card">
