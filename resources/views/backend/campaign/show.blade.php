...
<head>
  ...
  <title>{{ config('app.name') }} | {{ $campaign->title }}</title>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <ul class="nav nav-pills float-right">
                  <li class="nav-item" style="margin-right: 20px;"><a class="nav-link active" href="{{ url('/register') }}" data-toggle="tab">Sign Up</a></li>
                  <li class="nav-item"><a class="nav-link active" href="{{ url('/login') }}" data-toggle="tab">Login</a></li>
                </ul>
        </div>
        <div class="card-body">
          <div class="row">
